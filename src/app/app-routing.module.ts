...
import { AuthorizationComponent, DictionaryComponent, GamesComponent, HomeComponent, StatisticComponent, LoginComponent, RegisterComponent, AudioGameComponent } from '@feature/pages';
